...
export class ProblemsService {
  constructor(
    @InjectModel(Problem) readonly problemRepository: typeof Problem,
    @InjectModel(Task) readonly taskRepository: typeof Task,
  ) {}
  ...
  async update(dto: UpdateProblemDto) {
    ...
    const [updatedRows, [updatedProblems]] =
      await this.problemRepository.update(dto, {
